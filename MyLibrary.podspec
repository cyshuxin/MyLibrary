...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ChenYuan/MyLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ChenYuan' => 'chenyuan1@51.com' }
  s.source           = { :git => 'https://github.com/ChenYuan/MyLibrary.git', :tag => s.version.to_s }
